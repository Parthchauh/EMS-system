    ...
    >
      ...
      <div className="p-2 border-t border-sidebar-border space-y-1">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sidebar-muted hover:text-sidebar-foreground hover:bg-sidebar-accent/50 transition-colors w-full">
